...
int mat_A[MAX_MATRIX_SIZE][MAX_MATRIX_SIZE];
int mat_B[MAX_MATRIX_SIZE][MAX_MATRIX_SIZE];
int mat_C[MAX_MATRIX_SIZE][MAX_MATRIX_SIZE];
...
int main(int argc, char **argv) {
	...
	for (i = 0; i < thread_num; ++i)
		pthread_create(&thread[i], NULL, &addition, &counter[i]);
